        ...
        <div id="main">
            <div id="content">
                ...
                <div class="search">
                    ...
                    <form>
                        <span class='tooltips'><input type="text" onkeyup="show_hint(this.value, 'hint_offer_all.php?q=')">
                ...
                <?php
                        ...
                        $onpage = 5;
                        $all = $db->get_offer_number();
                        $start = $page->dopaging($onpage, $all, "list_offer_all.php?");

                        $result = $db->get_offer_list($start, $onpage);
                        echo "<table><tbody>";
                        while ($obj = $result->fetch_object()) {
                            ...
                            echo ">FIRMA: " . $obj->name . " STANOWISKO: " . $obj->job . "</a></td>";
...
//                            }
                        ...
                        echo "</tbody></table>";
                        $page->dopaging($onpage, $all, "list_offer_all.php?");
                    }
                } else {
