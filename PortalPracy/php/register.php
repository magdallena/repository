...
<html>
    <head>
        ...
        <script src='../js/switching_register_forms.js' type='text/javascript'></script>
...
//                TO DO: wyslac maila do admina
                    ...
                    <button type="button" class="register_button" id='student_reg_select'>Student</button>
                    <button type="button" class="register_button" id='teacher_reg_select'>Nauczyciel</button>
                    <button type="button" class="register_button" id='company_reg_select'>Firma</button>
