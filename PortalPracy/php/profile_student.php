            ...
            <div id="content">
                ...
                if (isset($_SESSION['name'])) {
                    ...
                    if ($id > $allstudents or $id == -1) {
                        ...
                        echo "<h3 class='datas_list'>" . $data['change_of_residence'] . "</h3>";
                        ...
                        while ($obj = $result->fetch_object()) {
                            ...
                            $ref = Reference::make_new_to_display($obj->teacher_id, $obj->name, $obj->last_name, $obj->academic_degree, $obj->date, $obj->content);
                            echo $ref->display();
                        }
